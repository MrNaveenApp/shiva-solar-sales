    ...
    () =>
      createTheme({
        ...
        typography: {
          ...
          button: { textTransform: 'none', fontSize: '0.8125rem' },
        },
        components: {
          ...
          MuiTableCell: { styleOverrides: { root: { fontSize: '0.8125rem', padding: '8px 12px' } } },
          MuiSelect: { styleOverrides: { root: { fontSize: '0.8125rem' } } },
